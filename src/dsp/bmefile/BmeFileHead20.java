...
import dsp.exception.FileException;
import dsp.util.FormatTransfer;
...
public class BmeFileHead20 extends BmeFileHead {
	 ...
	 * @see dsp.bmefile.BmeFileHead#getByteOrder()
	 */
	@Override
	...
	/**
	 * TODO 简单描述该方法的实现功能（可选）.
	 * @see dsp.bmefile.BmeFileHead#readFromStream(java.io.DataInputStream)
	 */
	@Override
	...
	/**
	 * TODO 简单描述该方法的实现功能（可选）.
	 * @see dsp.bmefile.BmeFileHead#writeToStream(java.io.DataOutputStream)
	 */
	@Override
